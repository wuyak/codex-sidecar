export function getDom() {
  ...
  return {
    ...
    offlineBookmarks: byId("offlineBookmarks"),
    ...
    bookmarkTabsToggleBtn: byId("bookmarkTabsToggleBtn"),
    bookmarkCount: byId("bookmarkCount"),
    ...
    offlineDetails: byId("offlineDetails"),
    offlineShowCount: byId("offlineShowCount"),
    offlineShowList: byId("offlineShowList"),
    importBtn: byId("importBtn"),
    importDialog: byId("importDialog"),
    importDialogCloseBtn: byId("importDialogCloseBtn"),
    importRel: byId("importRel"),
    importOpenBtn: byId("importOpenBtn"),
    importRefreshBtn: byId("importRefreshBtn"),
    importList: byId("importList"),
    importErrorText: byId("importErrorText"),
    ...
    watchHome: byId("watchHome"),
	    ...
	    notifySoundAssistant: byId("notifySoundAssistant"),
	    notifySoundToolGate: byId("notifySoundToolGate"),
	    uiTheme: byId("uiTheme"),
    uiFontSize: byId("uiFontSize"),
    uiBtnSize: byId("uiBtnSize"),
    quickViewDialog: byId("quickViewDialog"),
    quickViewDialogCloseBtn: byId("quickViewDialogCloseBtn"),
    quickBlocksSummary: byId("quickBlocksSummary"),
    quickBlockList: byId("quickBlockList"),
    quickBlocksResetBtn: byId("quickBlocksResetBtn"),
    quickBlocksErrorText: byId("quickBlocksErrorText"),
