export function getDom() {
  ...
  return {
    ...
    exportOptions: byId("exportOptions"),
    exportQuick: byId("exportQuick"),
    exportTranslate: byId("exportTranslate"),
    quickViewSettingsDetails: byId("quickViewSettingsDetails"),
