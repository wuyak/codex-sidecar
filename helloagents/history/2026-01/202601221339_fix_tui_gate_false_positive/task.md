...
## 3. 文档更新
- [√] 3.1 更新 `helloagents/wiki/modules/rollout_sidecar.md` 记录“误报规避”策略
...
## 5. 方案包迁移
- [√] 5.1 将本方案包迁移至 `helloagents/history/2026-01/202601221339_fix_tui_gate_false_positive/` 并更新 `helloagents/history/index.md`
