...
## 2. 文档更新
- [√] 2.1 更新 `helloagents/wiki/modules/rollout_sidecar.md` 记录 SSOT 位置

## 3. 质量检查
- [√] 3.1 运行 `python3 -m unittest discover -s tests`

## 4. 方案包迁移
- [√] 4.1 将本方案包迁移至 `helloagents/history/2026-01/202601221803_arch_refactor_phase38_ui_prefs_ssot/` 并更新 `helloagents/history/index.md`
