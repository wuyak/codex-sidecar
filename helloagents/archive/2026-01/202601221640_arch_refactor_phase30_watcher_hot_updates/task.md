...
- [√] 3.2 更新 `helloagents/modules/rollout_sidecar.md` 补充 control 分层条目（如适用）
...
## 5. 方案包迁移
- [√] 5.1 将本方案包迁移至 `helloagents/archive/2026-01/202601221640_arch_refactor_phase30_watcher_hot_updates/` 并更新 `helloagents/archive/_index.md`
