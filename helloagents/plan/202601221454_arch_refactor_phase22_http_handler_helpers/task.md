...
## 3. 文档更新
- [√] 3.1 更新 `helloagents/wiki/modules/rollout_sidecar.md`（http 分层补充）
...
## 5. 方案包迁移
- [ ] 5.1 将本方案包迁移至 `helloagents/history/2026-01/202601221454_arch_refactor_phase22_http_handler_helpers/` 并更新 `helloagents/history/index.md`
